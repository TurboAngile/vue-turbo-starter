...
export default {
  classes: {
    ...
    box: ({ props, data }: ThemeParams) => {
      ...
      if (props.size === 'xs') { c += ' px-2 py-1 text-xs' } else if (props.size === 'sm') { c += ' px-2 py-2 text-sm' } else if (props.size === 'lg') { c += ' px-4 py-3 text-lg' } else if (props.size === 'xl') { c += ' px-5 py-4 text-xl' } else { c += ' px-3 py-2' }
    ...
    icon: ({ props }: ThemeParams) => {
      if (props.size === 'sm' || props.size === 'xs') { return 'h-3 w-3' } else if (props.size === 'lg') { return 'h-6 w-6' } else if (props.size === 'xl') { return 'h-7 w-7' }
