...
export default {
  classes: {
    ...
    label: ({ props }: ThemeParams) => {
      ...
      if (props.size === 'xs') { return classes + ' text-xs' } else if (props.size === 'sm') { return classes + ' text-sm' } else if (props.size === 'lg') { return classes + ' text-lg' } else if (props.size === 'xl') { return classes + ' text-xl' }
    ...
    input: ({ props, data }: ThemeParams) => {
      ...
      if (props.size === 'xs') { classes.push('px-2 py-1 text-xs') } else if (props.size === 'sm') { classes.push('px-2 py-2 text-sm') } else if (props.size === 'lg') { classes.push('px-4 py-3 text-lg') } else if (props.size === 'xl') { classes.push('px-5 py-4 text-xl') } else { classes.push('px-3 py-2') }
